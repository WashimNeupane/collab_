...
//    double min, max;
//
//    //Deltas specify the offset in each direction
//    //If 000 Degree , DELTAS = [deltax deltay] = [D  ,  0]
//    //If 090 Degree , DELTAS = [deltax deltay] = [0  , -D]
//    //If 045 Degree , DELTAS = [deltax deltay] = [D  , -D]
//    //If 135 Degree , DELTAS = [deltax deltay] = [-D , -D]
//    std::vector<int> deltax({0});
//    std::vector<int> deltay({-1});
//
//
//    //Mat img = (Mat_<uchar>(3, 3) << 0,0,1,0,2,0,0,1,0);
//    //cout << img << endl;
//
//    Mat img = imread("C:\\WASHIM-RESEARCH\\GLCM\\opencv-haralickfeatures-master\\src\\image\\5.png",IMREAD_UNCHANGED);
//    vector<Mat> BGRPlane;
//    split(img, BGRPlane);
//    BGRPlane[1].convertTo(img, CV_8U, 1 / 257.0);
//    //Initialize m
//    double minVal;
//    double maxVal;
//    double nbit;
...
//    cout << maxVal;
//    Mat ans = MatCoocAdd(img, maxVal, deltax, deltay);
//    Mat ans2;
//    transpose(ans, ans2);
//    ans = ans + ans2;
...
//    Mat img2 = imread("C:\\WASHIM-RESEARCH\\GLCM\\opencv-haralickfeatures-master\\src\\image\\1.png", IMREAD_COLOR);
